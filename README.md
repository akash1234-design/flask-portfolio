...
| --- | --- | --- |
| **Finance Intelligence Dashboard** | Python, Streamlit, API | Live Stock Market + Portfolio Tracker with real-time data |
| **IPL Analytics Dashboard** | Python, Pandas, Plotly | Tournament & player performance analysis |
...
```bash
# Clone the repo
git clone https://github.com/akash1234-design/flask-portfolio.git
